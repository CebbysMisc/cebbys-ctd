...
class MetaVisitor(Antlr4.CtdVisitor):
    ...
    def visitCompilationUnit(
        self,
        ctx: Antlr4.CtdParser.CompilationUnitContext
    ) -> None:
    ...
    def visitStructureDeclaration(
        ...
        structure_meta = Meta.StructureMeta(name, self._current_namespace, base_type, members)
    ...
    def visitInterfaceDeclaration(
        ...
        interface_meta = Meta.InterfaceMeta(name, self._current_namespace, base_type, methods)

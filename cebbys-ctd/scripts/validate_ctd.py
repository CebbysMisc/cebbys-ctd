...
Run from the cebbys-ctd-loader module:
    cd cebbys-ctd-loader && uv run python scripts/validate_ctd.py
"""
...
def main() -> int:
    ...
    # Find resources relative to this script's parent directory
    script_dir = Pathlib.Path(__file__).parent.parent
    ctd_path = script_dir / 'resources' / 'ctd'
    ...
    try:
        loader = Loader.CtdLoader([ctd_path])

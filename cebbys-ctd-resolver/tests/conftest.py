...
import lv.cebbys.languages.ctd.antlr4 as Antlr4Ctd
...
def parse_ctd_file(file_path: Pathlib.Path) -> Visitor.MetaVisitor:
    ...
    Args:
        file_path: Path to the CTD file (relative to module root or absolute)
    ...
    lexer = Antlr4Ctd.CtdLexer(input_stream)
    token_stream = Antlr4.CommonTokenStream(lexer)
    parser = Antlr4Ctd.CtdParser(token_stream)
